      ...
      <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
        ...
        <li class="nav-item">
          ...
          <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
            <div class="bg-white py-2 collapse-inner rounded">
              <a class="collapse-item" href="<?= base_url('home/index') ?>">MENU GS</a>
              <a class="collapse-item" href="<?= base_url('hr/index') ?>">MENU HR</a>
            </div>
          </div>
        </li>
        ...
        <li class="nav-item">
          ...
          <div id="admin" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
            <div class="bg-white py-2 collapse-inner rounded">
              <a class="collapse-item" href="<?= base_url('dev/admin') ?>">Data Karyawan</a>
            </div>
          </div>
        </li>
