	...
	<body id="page-top">
		...
		<div id="wrapper">
			...
			<ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
				<!-- Sidebar - Brand -->
				<a class="sidebar-brand d-flex align-items-center justify-content-center" href="<?= base_url('user_karyawan') ?>">
				...
				<li class="nav-item">
					...
					<div id="makanan" class="collapse" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
						<div class="bg-white py-2 collapse-inner rounded">
							...
							<a class="collapse-item" href="<?= base_url('user_vendor/order_pending') ?>">Order Pending</a>
							<a class="collapse-item" href="<?= base_url('user_vendor/laporan_order') ?>">Laporan Selesai</a>
						</div>
					</div>
				</li>
				<!-- Divider -->
